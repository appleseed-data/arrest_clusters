from src.stages.stage_dataprep import run_pipeline_from_source
from src.stages.stage_charge_classification import run_charge_classification
...
def run_dataprep_pipeline(data_folder, models_folder, source_filename=None):
    ...
    df = run_charge_classification(data_folder, models_folder, filename='arrests_redacted.bz2', df=df)
